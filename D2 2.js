...
if (num1 >= num2) {
  console.log("Num 1 è maggiore di Num2");
} else {
...
if (num5 === 8 || num6 === 8) {
  ...
  console.log("La loro addizione o sottrazione è pari a 8");
} else {
  console.log("Nessuno dei due numeri è 8 e la loro addizione/sottrazione è diversa da 8");
}
